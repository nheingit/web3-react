...
export class MockPhantomProvider extends EventEmitter {
...
describe('Phantom', () => {
  let mockProvider: MockPhantomProvider
  ...
  beforeEach(() => {
    mockProvider = new MockPhantomProvider()
  ...
  describe('ethers', () => {
    ...
    test('works', async () => {
      ...
      connector = new Phantom({ actions, provider: wrapped })
  ...
  describe('functions', () => {
    describe('connectEagerly = true', () => {
      ...
      test('fails silently', async () => {
        connector = new Phantom({ actions, provider: mockProvider })
